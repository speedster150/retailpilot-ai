...
export default function SupplierManagement({
  ...
  return (
    <main className="space-y-6 p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-slate-200 pb-5">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="inline-flex items-center rounded-full bg-violet-50 px-2.5 py-0.5 text-xs font-semibold text-violet-700 border border-violet-200">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Registered Vendors</p>
            <span className="flex h-7 w-7 items-center justify-center rounded-md bg-violet-50 text-violet-700 border border-violet-100 text-xs">
              🏢
            </span>
          </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Inactive Accounts</p>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Active Open POs</p>
          ...
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-2xl font-bold text-indigo-700">{totalOpenPOs}</span>
      ...
      {isFormOpen && (
        <section className="rounded-xl border border-violet-100 bg-white p-6 shadow-md transition-all">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search by vendor name, contact person, phone, email, terms, or address..."
          ...
          <div className="overflow-x-auto">
            <table className="min-w-[950px] w-full text-left text-sm">
              <thead className="border-b border-slate-200 bg-slate-50/80 text-xs font-semibold uppercase tracking-wider text-slate-600">
                <tr>
                  <th scope="col" className="px-5 py-3.5">Supplier Name</th>
                  <th scope="col" className="px-4 py-3.5">Primary Contact</th>
                  <th scope="col" className="px-4 py-3.5">Communication Channels</th>
                  <th scope="col" className="px-4 py-3.5">Address / Location</th>
                  <th scope="col" className="px-4 py-3.5">Credit Terms & Orders</th>
